...
// class OldOpenReplDriver(settings: Array[String],
//                  out: PrintStream = Console.out,
//                  classLoader: Option[ClassLoader] = None,
//                  val prompt: String = "scala> ",
//                  val newLinePrompt: String = "     | ") extends Driver {
...
//    */
//   val terminal = OpenJLineTerminal(Prompt = prompt, NewLinePrompt = newLinePrompt)
