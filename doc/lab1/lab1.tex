...
Model(
  Product("hotelApp") interactsWith (
    ...
    System("accounting")))
\end{verbatim}}
Enter the code in your favorite editor and save the model in a text file called \verb+context.scala+
