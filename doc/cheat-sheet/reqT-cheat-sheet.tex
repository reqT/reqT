...
%\usepackage{xltxtra}%requires XeLaTeX
%\usepackage{fontspec}%requires XeLaTeX
% \usepackage{xunicode} %requires XeLaTeX
%   \setromanfont{Source Sans Pro} %{Source Sans Pro}
%   \setsansfont{Source Sans Pro} %{Source Sans Pro}
%   \setmonofont{DejaVu Sans Mono} %{DejaVu Sans Mono}
