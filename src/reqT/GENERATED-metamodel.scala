...
// *** Generation date: Thu Apr 17 22:23:44 CEST 2014 
// *** reqT version 3.0.0-snapshot build date Thu Apr 17 22:23:44 CEST 2014
/*** 
**                  _______        
**                 |__   __|       
...
object metamodel extends MetamodelTypes {
  ...
  lazy val requirementEntities: Vector[EntityType] = generalReqs ++ functionalReqs ++ qualityReqs ++ scenarioReqs
  lazy val generalReqs: Vector[EntityType] = Vector(Req, Idea, Feature, Goal)
  ...
  lazy val relationTypes: Vector[RelationType] = Vector(has, is, superOf) ++ Vector(requires, relatesTo)
