...
trait ModelBase extends Serializable {
  ...
  def toHtml = exporter.toHtml(this)
  def toHtmlBody = exporter.toHtml.body(this)
  def toLatex = exporter.toLatex(this)
  def toLatexBody = exporter.toLatex.body(this)
  def toText = exporter.toText(this)
