  ...
  lazy val initMenus =
    ...
    AppMenus(
      ...
      Menu("Tools", mnemonic = VK_O,
        ...
        Item("100$-test Normalized Votes", VK_4, VK_4, CTRL) { doNormalizedVotes() },
        Item("Id Pairs as Comparison Constraints", VK_2, VK_2, CTRL) { doAppendIdPairs() },
        Item("Solve Comparison Constraint Problem", VK_3, VK_3, CTRL) { doSolveConstraints() },
