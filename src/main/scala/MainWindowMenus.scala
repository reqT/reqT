  ...
  lazy val initMenus =
    ...
    AppMenus(
      ...
      Menu("Tools", mnemonic = VK_O,
        ...
        Item("Normalize Model", VK_N, VK_N, CTRL+SHIFT) { doNormalizeAll() },
        ...
        Item("Id Pairs as Constraints", VK_2, VK_2, CTRL) { doAppendIdPairs() },
        Item("Solve Constraints", VK_3, VK_3, CTRL) { doSolveConstraints() },
        Item("Normalized Votes", VK_4, VK_4, CTRL) { doNormalizedVotes() },
        Item("Scala Constructors to Log", VK_5, VK_5, CTRL) { doModelConstructorsToLog() },
        Item("Scala Classes to Log", VK_6, VK_6, CTRL) { doModelClassesToLog() },
